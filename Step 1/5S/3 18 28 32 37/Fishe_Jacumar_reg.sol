...
set  city[k] := Yaroslavl_ATAK;

set  city[i] := Yaroslavl_LENTA1;

set  city[i] := Yaroslavl_7Continent;

set  city[i] := Yaroslavl_ATAK;

set  city[i] := Yaroslavl_ASHANn;

set  city[i] := Yaroslavl_ASHANp;

set  city[i] := Yaroslavl_LENTA;

set  city[i] := Yaroslavl_Giperglobus;
...
set  city[k] := Ufa_OKEYe;

set  city[i] := NNovgorod_Okey;

set  city[i] := NaberezhnyeChelny_LENTA;

set  city[i] := Ufa_LENTA;

set  city[i] := Ufa_ASHAN;

set  city[i] := Ufa_OKEYe;

set  city[i] := Ufa_OKEYk;

set  city[i] := Ufa_OKEYmj;

set  city[i] := Ufa_Magnit;
...
set  city[i] := Ivanovo_7Continent;

set  city[i] := Ivanovo_Magnit;

set  city[i] := Ivanovo_Okey;

set  city[i] := Pyshma_Perekrestok;

set  city[i] := Yekaterinburg_ASHANh;
